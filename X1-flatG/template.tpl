            ...
            <tr align="center" valign="top">
                <td>
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="208" align="center" valign="top" bgcolor="#7e9d60">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatG/img/phone.png" width="11" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
                                        ...
                                        <td width="20"></td>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatG/img/mail.png" width="14" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
