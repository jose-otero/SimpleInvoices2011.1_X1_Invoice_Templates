            ...
            <tr align="center" valign="top">
                <td>
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="208" align="center" valign="top" bgcolor="#60609d">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatP/img/phone.png" width="11" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
                                        ...
                                        <td width="20"></td>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatP/img/mail.png" width="14" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
