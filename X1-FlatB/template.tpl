                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatB/img/phone.png" width="11" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
                                        ...
                                        <td width="20"></td>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatB/img/mail.png" width="14" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
