            ...
            <tr align="center" valign="top">
                <td>
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="208" align="center" valign="top" bgcolor="">
                                <table width="auto" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <!-- Compane Name -->
                                    <tr>
                                        <td style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#3b3b3b; line-height:20px; font-weight: bold;">{$biller.name|htmlsafe}</td>
                                    </tr>
                                    <!-- end Compane Name -->
                                    ...
                                    <!-- address -->
                                    <tr>
                                        <td style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:18px;">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatZ/img/phone.png" width="11" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
                                        ...
                                        <td width="20"></td>
                                        <td width="11" align="center" style="line-height:0px;">
                                            {*<img style="display:block;font-size:0px; border:0px; line-height:0px;" src="templates/invoices/X1-flatZ/img/mail.png" width="14" height="11" alt="img" />*}
                                        </td>
                                        <td width="10"></td>
